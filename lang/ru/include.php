...
$MESS['INTERVOLGA_EDU.COURSE2_LESSON1_COMPONENTINCLUDE'] = 'Проверка подключения "Слайдера"';
$MESS['INTERVOLGA_EDU.COURSE2_LESSON1_COMPONENTINCLUDE_DESCRIPTION'] = 'В header.php главной страницы должен подключаться компонент списка новостей с шаблоном слайдера';
$MESS['INTERVOLGA_EDU.COURSE2_LESSON1_SLIDER'] = 'Проверка содержимого шаблона Слайдера';
$MESS['INTERVOLGA_EDU.COURSE2_LESSON1_SLIDER_DESCRIPTION'] = 'Должны быть правильно заполнены ссылки, getList не должен быть в цикле, js-скрипты подключаются в правильном файле';
