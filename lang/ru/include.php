...
$MESS['INTERVOLGA_EDU.COURSE1_LESSON41_BOTTOMMENUITEMS'] = 'Проверка пунктов меню "О магазине"';
$MESS['INTERVOLGA_EDU.COURSE1_LESSON41_BOTTOMMENUITEMS_DESCRIPTION'] = 'В меню должны быть разделы: Отзывы, Контакты, Руководство, История';
