...
$MESS['INTERVOLGA_EDU.COURSE3_LESSON3_COMPONENT'] = 'Создать компонент выполняющий две функции (переключение функций сделать ссылками в шаблоне)';
...
$MESS['INTERVOLGA_EDU.CUSTOM_COMPONENT_FILE_NOT_FOUND'] = 'Компонент не имеет главного файла (component.php|class.php).';
$MESS['INTERVOLGA_EDU.CUSTOM_COMPONENT_HAS_NOT_SUBQUERY'] = 'Компонент не имеет функции SubQuery.';
...
$MESS['INTERVOLGA_EDU.CUSTOM_COMPONENT_RESPONDENT_DIRECTORY'] = 'Пользовательский компонент \'Голосование\'';
$MESS['INTERVOLGA_EDU.RESPONDENT_DIRECTORY'] = '\'Голосование\'';
