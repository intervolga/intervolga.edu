...
$MESS['INTERVOLGA_EDU.ASSERT_FSE_EXISTS'] = '<div>Файл #VALUE# не найден</div>';
$MESS['INTERVOLGA_EDU.ASSERT_FSE_NOT_EXISTS'] = '<div>#VALUE# требуется удалить</div>';
$MESS['INTERVOLGA_EDU.ASSERT_FILE_IS_IMAGE'] = '<div>Файл #VALUE# должен быть картинкой</div>';
$MESS['INTERVOLGA_EDU.ASSERT_FSE_NAME_MATCH'] = '<div>Имя файла должно иметь вид <b>#EXPECT#</b>, сейчас #VALUE#</div>';
$MESS['INTERVOLGA_EDU.ASSERT_FILE_CONTENT_NOT_MATCH'] = '<div>Файл #VALUE# содержит <b>#EXPECT#</b></div>';
$MESS['INTERVOLGA_EDU.ASSERT_FILE_CONTENT_MATCH'] = '<div>Файл #VALUE# не содержит <b>#EXPECT#</b></div>';
$MESS['INTERVOLGA_EDU.ASSERT_DIRECTORY_EXISTS'] = '<div>Папка #VALUE# не найдена</div>';
$MESS['INTERVOLGA_EDU.ASSERT_DIRECTORY_NOT_EXISTS'] = '<div>Папка #VALUE# существует, должна быть удалена</div>';
$MESS['INTERVOLGA_EDU.ASSERT_FILE_NOT_EXISTS'] = '<div>Файл #VALUE# существует, должен быть удален</div>';
$MESS['INTERVOLGA_EDU.FSE'] = '<a href="#FILEMAN_URL#" target="_blank"><b>#NAME#</b></a>';
...
$MESS['INTERVOLGA_EDU.ASSERT_MENU_ITEM_NOT_EXISTS'] = '<div>Пункт #ITEM# в меню #MENU# должен быть удален</div>';
$MESS['INTERVOLGA_EDU.ASSERT_MENU_ITEM_EXISTS'] = '<div>Пункт #ITEM# в меню #MENU# не найден, должен существовать</div>';
