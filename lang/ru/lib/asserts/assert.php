...
$MESS['INTERVOLGA_EDU.ASSERT_EVENT_EXISTS'] = 'Обработчик события "#MESSAGE_ID#" для модуля "#MODULE_ID#" не найден, должен существовать!<br>Требуемые поля:<br>#REQUIRED_RULES#';
