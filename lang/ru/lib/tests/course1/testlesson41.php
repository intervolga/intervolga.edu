<?php
$MESS['INTERVOLGA_EDU.TEST_COURSE_1_LESSON_4_1'] = 'Курс 1. Урок 4.1 Компоненты. Часть 1';
...
$MESS['INTERVOLGA_EDU.IMAGES_DELETE_REASON'] = 'папка images не требуется для выполнения задания';