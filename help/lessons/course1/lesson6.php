...
<ol>
	...
	<li>Компонент должен проверять любые данные перед выводом, чтобы не было пустых атрибутов href у ссылок, src у изображений, пустых кавычек или странных пустот в верстке.
		<br> <img src="<?= MODULE_DIR ?>/help/images/course1lesson6checkemptydata.png"></li>
	<li>Свойства нужно выводить из <i>DISPLAY_PROPERTIES</i>. Поля из <i>FIELDS</i>.<br><img src="<?= MODULE_DIR ?>/help/images/course1lesson6correctshowdata.png"></li>
